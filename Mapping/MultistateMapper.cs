...
namespace DotLToExcel.Mapping
{
    ...
    {
        public IEnumerable<Multistate> MapMultistate(List<string> data)
        {
            ...
            try
            {
                ...
                {
                    CreateMultistate(data, digital, i);
                }
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<Multistate> MapMultistate(List<string> data, HashSet<string> anrData)
        {
            int FieldLength = MultistateFields.Fields.Length;
            var digital = new List<Multistate>();
        ...
        private static void CreateMultistate(List<string> data, List<Multistate> digital, int i)
        {
            var multistate = new Multistate
            {
                ...
                LegacyName = data[i + 35],
                DisplayOrder = Convert.ToInt32(data[i + 36]),
