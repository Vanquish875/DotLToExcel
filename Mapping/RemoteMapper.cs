...
namespace DotLToExcel.Mapping
{
    ...
    {
        public List<Remote> MapRemote(IList<string> data, Dictionary<string, string> ConnectionRemote, HashSet<string> groups)
        {
            var FieldLength = RemoteFields.Fields.Length;
