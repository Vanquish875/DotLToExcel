...
namespace DotLToExcel.Mapping
{
    ...
    {
        public IEnumerable<Digital> MapStatus(List<string> data, Dictionary<string, string> Messages)
        {
            ...
            try
            {
                ...
                {
                    CreateStatus(data, Messages, digital, i);
                }
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<Digital> MapStatus(List<string> data, Dictionary<string, string> Messages, HashSet<string> anrData)
        {
            int FieldLength = StatusFields.Fields.Length;
            var digital = new List<Digital>();
        ...
        private static void CreateStatus(List<string> data, Dictionary<string, string> Messages, List<Digital> digital, int i)
        {
