...
namespace DotLToExcel.POCOS
{
    public class Multistate
    {
        ...
        public string CoordinatesBit3 { get; set; }
        public int BitNumberBit3 { get; set; }
        public string CoordinatesBit4 { get; set; }
        public int BitNumberBit4 { get; set; }
        public string CoordinatesBit5 { get; set; }
        public int BitNumberBit5 { get; set; }
        public string CoordinatesBit6 { get; set; }
        public int BitNumberBit6 { get; set; }
        public string CoordinatesBit7 { get; set; }
        public int BitNumberBit7 { get; set; }
        public string CoordinatesBit8 { get; set; }
        public int BitNumberBit8 { get; set; }
